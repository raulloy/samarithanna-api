    ...
    <div style="text-align: center;">
      ...
      <table style="margin: auto; width: 80%; border-collapse: collapse; border: 1px solid #ccc;">
        ...
        <tfoot>
          ...
          <tr>
            <td style="border: 1px solid #ddd; padding: 8px;"></td>
            <td style="border: 1px solid #ddd; padding: 8px; text-align: right;"><strong>IVA:</strong></td>
            <td style="text-align: right; border: 1px solid #ddd; padding: 8px;"><strong>$${order.taxPrice.toFixed(
              2
            )}</strong></td>
          </tr>
          <tr>
